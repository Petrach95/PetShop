...
<body>
	...
	<section>
		...
		<div>
				...
				<table cellpadding="0" cellspacing="0" border="0">
					<tbody>
						...
						<tr>
							...
							<td><%=c.getTelefono()%></td>
							<td>
								<button class="btm btm_td"
									onclick="toggleAnimali(<%=c.getId()%>)">Acquisti</button>
							</td>
							<td>Modifica</td>
						</tr>
						<tr id="animali-<%=c.getId()%>" style="display: none;">
							<th></th>
							<th>ID</th>
							<th>TIPO</th>
							<th>NOME</th>
			...
			<h3>
				Carica il file xls per inserire nuovi dati	
			</h3>
				<input type="file" name="vendite">
