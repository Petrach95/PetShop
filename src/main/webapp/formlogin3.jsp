...
<!-- 							src="https://images.unsplash.com/42/U7Fc1sy5SCUDIu4tlJY3_NY_by_PhilippHenzler_philmotion.de.jpg?ixlib=rb-0.3.5&q=50&fm=jpg&crop=entropy&s=7686972873678f32efaf2cd79671673d" /> -->
					...
					<div class="cont_form_sign_up" <% if (next != null) out.println("style='display: block; opacity: 1;'"); %> >
						...
						<form action="LoginRegister" method="get">
							...
							<input type="checkbox" name="old" value="si" style="margin-left:0;"/> 
						...
						<form action="LoginRegister?login=False" method="post" >
							<input type="text" name="nome" placeholder="Nome" <% out.println("value='"+utente.getNome()+"'"); %> hidden="hidden"/> 
							<input type="text" name="cognome" placeholder="Cognome" <%  out.println("value='"+utente.getCognome()+"'"); %> hidden="hidden"/> 
							<input type="email" name="email" placeholder="Email" <%  out.println("value='"+utente.getEmail()+"'"); %> hidden="hidden"/> 
							<input type="text" name="tel" placeholder="Telefono" <%  out.println("value='"+utente.getTelefono()+"'"); %> hidden="hidden"/> 
							<input type="date" name="data" placeholder="Data di Nascita" <% out.println("value='"+utente.getDataNascita()+"'"); %> hidden="hidden"/> 
